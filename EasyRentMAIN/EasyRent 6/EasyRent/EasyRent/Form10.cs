...
namespace EasyRent
{
    public partial class Form10 : Form
    {
        ...
        string connectionString = "data source=DESKTOP-5903S8A\\SQLEXPRESS; database=EasyRent; integrated security=SSPI"; // Default automatically called at the first.Initialize with your database connection string
        public Form10()
        {
            InitializeComponent();
