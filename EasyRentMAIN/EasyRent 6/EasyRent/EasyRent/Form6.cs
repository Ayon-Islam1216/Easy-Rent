    ...
    public partial class Form6 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            if (isCollapsed)
            {
                ...
                {
                    panel2.Height = panel2.MaximumSize.Height; // Ensure exact match
                    timer1.Stop();
                    isCollapsed = false; // Mark as expanded
                }
            }
            else
            {
                ...
                {
                    panel2.Height = panel2.MinimumSize.Height; // Ensure exact match
                    timer1.Stop();
